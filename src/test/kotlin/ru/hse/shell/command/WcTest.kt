...
internal class WcTest {
    private val argsTestData = listOf(
        listOf("") to Pair("", 1),
        listOf("src/test/resources/wc.txt") to Pair("2 4 17 src/test/resources/wc.txt" + System.lineSeparator(), 0),
        listOf("src/test/resources/wc2.txt") to Pair("5 5 9 src/test/resources/wc2.txt" + System.lineSeparator(), 0),
        listOf("src/test/resources/wc.txt", "src/test/resources/wc2.txt") to Pair(
            "2 4 17 src/test/resources/wc.txt" + System.lineSeparator()
                    + "5 5 9 src/test/resources/wc2.txt" + System.lineSeparator()
                    + "7 9 26 total" + System.lineSeparator(), 0
        )
    )
    ...
    private val noArgsTestData = listOf(
        "" to Pair("0 0 0 total" + System.lineSeparator(), 0),
        "1234 5" to Pair("1 2 6 total" + System.lineSeparator(), 0),
        "12\n3\t4\n" to Pair("2 3 7 total" + System.lineSeparator(), 0)
    )
